...
import backend.common.util.VerdictUtil;
...
import backend.common.exception.BatchNotFoundException;
import backend.common.exception.ReportNotFoundException;
import backend.modules.report.ReportStore;
import backend.modules.report.ReportStore.ReportData;
...
public class ReportService {
    ...
    public MatchesResponse getMatchesReport(String id) {
        ...
        // Build line maps
        List<Integer> lineMapA = backend.modules.similarity.Tokenizer.buildLineMap(r.rawA());
        List<Integer> lineMapB = backend.modules.similarity.Tokenizer.buildLineMap(r.rawB());
